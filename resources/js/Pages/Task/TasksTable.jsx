        ...
        <>
            ...
            <div className="overflow-auto">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 dark:text-gray-400 uppercase bg-gray-50
                            ...
                            >
                                ...
                                ">
                                    <Link href={route("task.show", task.id)}>
                                        {task.name} and Assigned - {task.assigned_user_id} and createdBy - {task.createdBy.id}
                                    </Link>
                                </th>
